...
public final class MultitoolState {
    ...
    public static boolean isLiveMirrorHorizontal(ItemStack stack) {
        return stack.getOrDefault(DataComponents.CUSTOM_DATA, CustomData.EMPTY)
                .copyTag().getBooleanOr(LIVE_MIRROR_HORIZONTAL, false);
    }

    public static boolean isLiveMirrorVertical(ItemStack stack) {
        return stack.getOrDefault(DataComponents.CUSTOM_DATA, CustomData.EMPTY)
                .copyTag().getBooleanOr(LIVE_MIRROR_VERTICAL, false);
    }
    ...
    private static void restoreGeneralProfile(ItemStack stack, MultitoolMode mode) {
        ...
        setLiveMirror(stack, false, initialized && profile.getBooleanOr(LIVE_MIRROR_HORIZONTAL, false));
        setLiveMirror(stack, true, initialized && profile.getBooleanOr(LIVE_MIRROR_VERTICAL, false));
    }
